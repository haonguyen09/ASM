...
class ProducerController extends Controller
{
    ...
    public function save2(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Producer Added Successfully');// key:value
    }


    public function edit2($id) 
    {
        $data2 = Producer::where('producerID', '=', $id)->first(); // first: gọi ra bản ghi đầu tiên, có nghĩa là chúng ta sẽ lấy ra producerID đầu tiên mà admin muốn edit
        // $producers = Producer::get();
        return view('edit2', compact('data2'));
    }
