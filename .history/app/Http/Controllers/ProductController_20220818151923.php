...
class ProductController extends Controller
{
    ...
    public function edit2($id) 
    {
        ...
        // return view('edit', compact('data'));
        $product = Producer::get();
        return view('edit2', compact('data2','product'));
    }
    ...
    {
        Producer::delete('delete from producer when producerID = ', [$id2]);
        return redirect('list2')->with('success','Producer Deleted');
    }
}
