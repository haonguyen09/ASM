...
class ProductController extends Controller
{
    ...
    {// Product: tên class, :: phương thức static
        ...
        $data = Product::select('products.*', 'producer.producerName')
        ->join('producers', 'producers.producerID', '=', 'products.user_id')
        ->join('orders', 'users.id', '=', 'orders.user_id')
        ->get(); // or first()
        return view('list2', compact('data')); // lấy dữ liệu của data và trả kết quả về view/list
    }
