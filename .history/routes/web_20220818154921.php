...
Route::get('list2', // dùng method static get để truy cập tới đường link tên là list
[ProductController::class, // giá trị trả về là ProductController
'index2']);
...
Route::get('edit2/{id}', [ProductController::class, 'edit2']); // đây là kiểu router có tham số, tìm trong ProductController sẽ thấy tham số $id trong hàm edit
Route::post('update', [ProductController::class, 'update']);
Route::get('delete/{id}', [ProductController::class, 'delete']);
Route::get('delete2/{producers}', [ProductController::class, 'delete2']);
