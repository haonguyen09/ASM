               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        ...
                        <div class="user_img"><img class="img-responsive" src="images/admin/{{$row->adminImage}}" alt="#" width="70px" height="70px"/></div>
                        <div class="user_info">
                           <h6>{{$row->adminName}}</h6>
...
<div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        <a href="{{url('customerAccount')}}"><i class="fa fa-diamond purple_color"></i> <span>Customer</span></a>
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown">
                                       {{-- @foreach ($admins as $row)
                                          <img class="img-responsive rounded-circle" src="images/admin/{{$row->adminImage}}" alt="#" width="35px" height="35px" />
                                          <span class="name_user">{{$row->adminName}}</span>
                                       @endforeach --}}
                                    </a>
