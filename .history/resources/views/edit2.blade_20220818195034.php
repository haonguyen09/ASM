            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{url('update')}}" method="POST">
                        ...
                        <div class="md-3">
                            <label for="name" class="form-label">Producer Country</label>
                            <input type="text" name="country" class="form-control"
                            value="{{$data2->producerCountry}}">
                        </div>
                        
                        <div class="md-3">
                            <label for="producer" class="form-label">Edit Producer Name </label>
