               ...
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="index.html"><img class="logo_icon img-responsive" src="images/dashboard/logo/logo_icon.png" alt="#" /></a>
                     </div>
                  </div>
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        ...
                        <div class="user_img"><img class="img-responsive" src="{{url('images/admin/' . Session::get('loginadminImage'))}}" alt="#" width="70px" height="70px"/></div>
                        <div class="user_info">
                           <h6>{{Session::get('loginadminName')}}</h6>
...
<h4>General</h4>
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="{{url('adminAccount')}}"><i class="fa fa-clock-o orange_color"></i> <span>Admin</span></a></li>
                     <li>
                        <a href="{{url('customerAccount')}}"><i class="fa fa-diamond purple_color"></i> <span>User</span></a>
                      ...
                      <li><a href="tables.html"><i class="fa fa-table purple_color2"></i> <span>Producer</span></a></li>
                     <!-- <li>
                     ...
                     <li><a href="{{url('list')}}"><i class="fa fa-briefcase blue1_color"></i> <span>Product</span></a></li> 
                     <li>
                        <a href="contact.html">
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="index.html"><img class="img-responsive" src="images/dashboard/logo/logo.png" alt="#" /></a>
                        </div>
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown">
                                          ...
                                          <img class="img-responsive rounded-circle" src="{{url('images/admin/' . Session::get('loginadminImage'))}}" alt="#" width="35px" height="35px" />
                                          <span class="name_user">{{Session::get('loginadminName')}}</span>
                                    
                                    </a>
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="{{ url('editAdmin/' . Session::get('loginadminID')) }}">My Profile</a>
                                       <a class="dropdown-item" href="settings.html">Settings</a>
                                       <a class="dropdown-item" href="help.html">Help</a>
                                       <a class="dropdown-item" href="{{url('logoutAdmin')}}">Log Out<i class="fa fa-sign-out"></i></a>
                                    </div>
                                 </li>
                              </ul>
                           </div>
                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="images/dashboard/layout_img/user_img.jpg" alt=""></div>
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="images/dashboard/layout_img/msg2.png" class="img-responsive" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="images/dashboard/layout_img/msg3.png" class="img-responsive" alt="#" /></span>
                                          <span>
