    ...
    <div class="container" style="margin-top: 50px">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <div style="margin-right: 10%; float: right; margin-top: 10%;">
			        <input type="text" class="btn btn-outline-success placeholder="Search"/>
                    <a href="{{ url('add') }}" class="btn btn-outline-success">Search</a>
                </div>
                <div style="margin-right: 10%; float: left; margin-top: 10%;">
