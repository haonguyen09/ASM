			...
			<h2>Registration Form</h2>				
					<form action="{{route('register-process')}}" method="POST">
						...
						<div class="form-info">
						    ...
						    <input type="text" class="text" name="address" value="Your Adress" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Adress';}" >
                            <input type="text" class="text" name="email" value="Email Adress" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email Adress';}" >
