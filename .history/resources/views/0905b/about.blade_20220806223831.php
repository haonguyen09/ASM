...
<div class="header-bg">
	<div class="wrap"> 
				...
				<div class="header">
					<div class="box_header_user_menu">
						<ul class="user_menu">
                            ...
                            <li class=""><a href="#"><div class="button-t"><span>Create an Account</span></div></a></li>
                            <li class="last"><a href="#"><div class="button-t"><span>Log in</span></div></a></li></ul>
					</div>
		...
		<div class="banner-top">
			<div class="header-bottom">
				 <div class="header_bottom_right_images">
				 	<div class="about_wrapper"><h1>Motorcycle Store Online</h1>
					</div>
				    <div class="about-group">
		  			<div class="about-top">	
						...
						<div class="grid span_2_of_3">
							<h3>Greenwich Teams</h3>
							<p>Our Motorcycle website specializes in selling motorcycles such as Manual clutch, Automatic Transmission Motorcycle, Manual Transmission Motorcycle, and some motorbike accessories. The client easily buys on my website because our website user-friendly interface. After registering, a user can use the system by logging in with their username and password. The user can explore each motorcycle's attributes and search through various motorcycle listings. Furthermore, our products have a lot of variety of models and updated regularly. To sum up, we have been constantly developing and becoming one of the leading companies in the field of motorcycle manufacturing and a prestigious automobile manufacturer in the Vietnamese market.</p>
						</div><div class="clear"></div> 
					</div>
		...
		<div class="footer-bottom">
			<div class="copy">
				<p>&copy 2022 Motorcycle Online . All rights Reserved | Design by <a href="http://w3layouts.com">Motorcycle Teams</a></p>
			</div>
		</div>
		</div>
</div>
