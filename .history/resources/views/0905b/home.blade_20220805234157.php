								...
								<div class="grid_1_of_3 images_1_of_3">
									...
									<div class="grid_1_of_3 images_1_of_3">
										...
										<a href="single.html"><img src="images/pic3.jpg" title="continue reading" alt=""></a>
											<div class="grid_desc">
												<p class="title">Vision</p>
												<p class="title1">With its top-notch performance engine and luxurious appearance suitable for both city and off-road trips, the Gold Wing has been dubbed Honda's iconic and premium touring car.</p>
													 <div class="price" style="height: 19px;">
													 	 <span class="reducedfrom">$66.00</span>
								        				<span class="actual">$12.00</span>
													</div>
