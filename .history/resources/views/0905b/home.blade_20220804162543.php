			...
			<div class="total">
				<div class="header">
					...
					<div class="header-bot">
						<div class="logo">
							<a href="index.html"><img src="laravel0905b/public/images/logo.png" alt="" width="60px" height="40px"/></a>
						</div>
						<div class="search">
		...
		<div class="banner-top">
			<div class="header-bottom">
				 <div class="header_bottom_right_images">
				     	<div id="slideshow">
							<ul class="slides">
						    	<li><a href="details.html"><canvas ></canvas><img src="public/images/banner4.jpg" alt="Marsa Alam underawter close up" ></a></li>
						        <li><a href="details.html"><canvas></canvas><img src="laravel0905b/public/images/banner2.jpg" alt="Turrimetta Beach - Dawn" ></a></li>
						        <li><a href="details.html"><canvas></canvas><img src="laravel0905b/public/images/banner3.jpg" alt="Power Station" ></a></li>
						        <li><a href="details.html"><canvas></canvas><img src="laravel0905b/public/images/banner1.jpg" alt="Colors of Nature" ></a></li>
						    </ul>
