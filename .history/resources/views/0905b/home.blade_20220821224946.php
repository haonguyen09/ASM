				...
				<div class="header">
					<div class="box_header_user_menu">
						<ul class="user_menu">
                            ...
                            <li class="last"><a href="{{url('information/' . Session::get('loginID'))}}"><div class="button-t"><span>Welcome: {{Session::get('loginID')}}</span></div></a></li>
                            <li class="last"><a href="{{url('logout')}}"><div class="button-t"><span>Logout</span></div></a></li>
							@else
							<li class=""><a href="{{url('register')}}"><div class="button-t"><span>Create an Account</span></div></a></li>
                            <li class="last"><a href="{{url('login')}}"><div class="button-t"><span>Login Customer</span></div></a></li>
							@endif
							{{-- <li class="last"><a href="{{url('loginAdmin')}}"><div class="button-t"><span>Admin Login</span></div></a></li> --}}
						</ul>
		...
		<div class="banner-top">
			<div class="header-bottom">
				 <div class="header_bottom_right_images">
				     	<div id="slideshow">
							<ul class="slides">
						    	<li><a href="#"><canvas></canvas><img src="images/banner4.jpg" alt="Marsa Alam underawter close up" style="width: 450px"></a></li>
