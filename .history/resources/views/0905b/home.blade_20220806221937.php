		...
		<div class="banner-top">
			<div class="header-bottom">
				 <div class="header_bottom_right_images">
				     	<div id="slideshow">
							<ul class="slides">
						    	<li><a href="details.html"><img src="images/banner4.jpg" alt="Marsa Alam underawter close up" ></a></li>
						        <li><a href="details.html"><img src="images/banner2.jpg" alt="Turrimetta Beach - Dawn" ></a></li>
						        <li><a href="details.html"><img src="images/banner3.jpg" alt="Power Station" ></a></li>
						        <li><a href="details.html"><img src="images/banner1.jpg" alt="Colors of Nature" ></a></li>
						    </ul>
