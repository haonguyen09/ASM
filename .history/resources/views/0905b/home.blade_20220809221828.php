				...
				<div class="header">
					<div class="box_header_user_menu">
						<ul class="user_menu">
                            ...
                            <li class="last"><a href="{{url('login')}}"><div class="button-t"><span>Log in</span></div></a></li>
                            <li class="last"><a href="{{url('login')}}"><div class="button-t"><span>Log out</span></div></a></li>
						</ul>
