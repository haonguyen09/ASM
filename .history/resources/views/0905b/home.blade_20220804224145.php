			...
			<div class="total">
				<div class="header">
					<div class="box_header_user_menu">
						<ul class="user_menu"><li class="act first"></li><li class=""><a href="#"><div class="button-t"><span>Advanced Search</span></div></a></li><li class=""><a href="{{url('register')}}"><div class="button-t"><span>Create an Account</span></div></a></li><li class="last"><a href="{{url('login')}}"><div class="button-t"><span>Log in</span></div></a></li></ul>
					</div>
