				 ...
				 <div class="header_bottom_right_images">
				     	<div id="slideshow">
							<ul class="slides">
						        ...
						        <li><a href="details.html"><canvas></canvas><img src="public/images/banner2.jpg" alt="Turrimetta Beach - Dawn" ></a></li>
						        <li><a href="details.html"><canvas></canvas><img src="public/images/banner3.jpg" alt="Power Station" ></a></li>
						        <li><a href="details.html"><canvas></canvas><img src="public/images/banner1.jpg" alt="Colors of Nature" ></a></li>
						    </ul>
