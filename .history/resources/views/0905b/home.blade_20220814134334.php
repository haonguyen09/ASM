...
<div class="header-bg">
	<div class="wrap"> 
				...
				<div class="header">
					<div class="box_header_user_menu">
						<ul class="user_menu">
                            ...
                            <li class="last"><a href="{{url('login')}}"><div class="button-t"><span>Login</span></div></a></li>
                            <li class="last"><a href="{{url('login')}}"><div class="button-t"><span>Logout</span></div></a></li>
						</ul>
					...
					<div class="header-bot">
						<div class="logo">
							<a href="{{url('/')}}"><img src="images/logo.jpg" style="background-color: orangered; padding: 20px"/></a>
						</div>
						<div class="search">
		...
		<div class="menu"> 	
			<div class="top-nav"> 
					<ul>
						...
						<li><a href="{{url('cars')}}">Motorcycle</a></li>
		...
		<div class="banner-top">
			<div class="header-bottom">
				 <div class="header_bottom_right_images">
				     	<div id="slideshow">
							<ul class="slides">
						    	<li><a href="details.html"><canvas ></canvas><img class="banner4" src="images/banner4.jpg" alt="Marsa Alam underawter close up" ></a></li>
		  			...
		  			<div class="content-wrapper">		  
								...
								<div class="grid_1_of_3 images_1_of_3">
									<div class="grid_1">
										<a href="single.html"><img src="images/pic5.jpg" title="continue reading" alt=""></a>
											<div class="grid_desc">
												<p class="title">SH 125i</p>
												<p class="title1">Inheriting the quintessence of the SH series with elegant and luxurious lines bearing European breath and a breakthrough improved engine and advanced technology, the new SH125i/150i adds an impressive and outstanding new color.</p>
													 <div class="price" style="height: 19px;">
													 	 <span class="reducedfrom">$4.000</span>
								        				<span class="actual">$4.500</span>
													</div>
									...
									<div class="grid_1_of_3 images_1_of_3">
										...
										<a href="single.html"><img src="images/pic6.jpg" title="continue reading" alt=""></a>
											<div class="grid_desc">
												...
												<p class="title1">The quintessence of the new version Vision luxurious lines bearing European breath and a breakthrough improved engine and advanced technology, the new vision adds an impressive and outstanding new color.</p>
													 <div class="price" style="height: 19px;">
													 	 <span class="reducedfrom">$3.000</span>
								        				<span class="actual">$3.100</span>
													</div>
													<div class="cart-button">
														<div class="cart">
															<a href="#"><img src="images/cart.png" alt=""/></a>
									...
									<div class="grid_1_of_3 images_1_of_3">
										...
										<a href="single.html"><img src="images/pic4.jpg" title="continue reading" alt=""></a>
											<div class="grid_desc">
												<p class="title">Air Blade 150</p>
												<p class="title1">Worthy of the top mid-range sport scooter for more than a decade, the all-new AIR BLADE is now upgraded with the most advanced, exclusive 4-valve eSP+ engine to bring in pioneering power.</p>
													 <div class="price" style="height: 19px;">
						...
						<div class="content-top" style="width: 490px, height: 200p0x">
								...
								<div class="grid_1_of_3 images_1_of_3">
									<div class="grid_1">
										<a href="single.html"><img src="images/pic1.jpg" title="continue reading" alt=""></a>
											<div class="grid_desc">
												<p class="title">Winner X</p>
												<p class="title1">Life is an adventure full of surprises and everyone has their own finish line. Be confident in taking shots to soar and make your own mark with the new Honda WINNER X.</p>
													 <div class="price" style="height: 19px;">
													 	 <span class="reducedfrom">$2.000</span>
								        				<span class="actual">$2.200</span>
													</div>
													<div class="cart-button">
														<div class="cart">
															<a href="#"><img src="images/cart.png" alt=""/></a>
									...
									<div class="grid_1_of_3 images_1_of_3">
										...
										<a href="single.html"><img src="images/pic2.jpg" title="continue reading" alt=""></a>
											<div class="grid_desc">
												<p class="title">Wave Alpha 110cc</p>
												<p class="title1">Wave Alpha 110cc version 2020 is youthful and personality with a new stamp design, creating impressive highlights, attracting eyes, giving you the confidence to make a mark with your friends on every journey.</p>
													 <div class="price" style="height: 19px;">
													 	 <span class="reducedfrom">$900</span>
								        				<span class="actual">$950</span>
													</div>
													<div class="cart-button">
														<div class="cart">
															<a href="#"><img src="images/cart.png" alt=""/></a>
									...
									<div class="grid_1_of_3 images_1_of_3">
										...
										<a href="single.html"><img src="images/pic3.jpg" title="continue reading" alt=""></a>
											<div class="grid_desc">
												<p class="title">Vision</p>
												<p class="title1">With its top-notch performance engine and luxurious appearance suitable.</p>
													 <div class="price" style="height: 19px;">
													 	 <span class="reducedfrom">$66.00</span>
								        				<span class="actual">$12.00</span>
													</div>
		...
		<div class="footer-bottom">
			<div class="copy">
				<p>Motorcycle Store Online . All rights Reserved | Design by <a href="http://greenwich.edu.vn">Motorcycle Teams</a></p>
			</div>
		</div>
</div>
</div>
